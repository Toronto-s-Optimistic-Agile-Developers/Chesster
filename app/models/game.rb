  ...
  def set_up_board!
    ...
    #Pawns
      (0..7).each do |x_coord|
        ...
        Pawn.create(game: self, color: "white", x_coord: x_coord, y_coord: 6, name: "White_Pawn", image: "&#9817;")
      end
      ...
      # Rooks
      [0, 7].each do |x_coord|
        Rook.create(game: self, color: "white", x_coord: x_coord, y_coord: 0, white_id: user_id, name: "White_Rook", image: "&#9814;", player_id: user_id)
      end
  
      [0, 7].each do |x_coord|
        Rook.create(game: self, color: "black", x_coord: x_coord, y_coord: 7, black_id: user_id, name: "Black_Rook", image: "&#9820;", player_id: user_id)
      end
  
     # Knights
      [1, 6].each do |x_coord|
        Knight.create(game: self, color: "white", x_coord: x_coord, y_coord: 7, name: "White_Knight", image: "&#9816;", player_id: user_id)
      end
